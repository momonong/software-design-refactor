...
import math
import os
from setting import PATH, BASE
from color_setting import *

pygame.init()
ENEMY_IMAGE = pygame.image.load(os.path.join("image/Enemy", "fireA-0.png"))
...
class Enemy:
    def __init__(self):
        ...
        self.move_count = 0
        self.stride = 1.5
        self.image = pygame.transform.scale(ENEMY_IMAGE, (60, 70))
...
class EnemyGroup:
    def __init__(self):
        ...
        self.campaign_max_count = 40   # (unit: frame)
