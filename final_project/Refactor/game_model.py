...
class GameModel:
    def __init__(self):
        ...
        self.__towers = [Tower.Fireman(255, 245), Tower.Firetruck(420, 400)]
        self.__enemies = EnemyGroup()
        self.__menu = None
        self.__main_menu = MainMenu()
        self.__plots = [Vacancy(630, 400), Vacancy(800, 300)]
        # selected item
        ...
        self.mute = Mute(self.subject)
        self.music = Music(self.subject)
        self.continue_ = Continue(self.subject)
